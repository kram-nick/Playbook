...
const SignIn = () => {
  ...
  const formikForm = useFormik<{
    ...
    onSubmit: async (values: any) => {
      ...
      // } else {
      // toast.error(t<string>("COMMON.CAPTCHA"));
      // }
    },
  });
        ...
        >
          ...
          <div className="form-group mb-[24px] relative">
            ...
            <input
              ...
              name="password"
              className={classNames({
                "py-[10px] px-[16px] rounded-[5px]  placeholder:text-input-placeholder border-solid border-[1px] shadow-free-trial w-[100%] pr-[46px]":
                  true,
                "leading-[18px] font-normal font-poppins text-[16px] tracking-[-0.01px] outline-none box-border":
                  true,
                "border-error-color":
