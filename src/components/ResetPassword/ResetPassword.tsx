    ...
    <div className="flex mx-auto  min-h-[calc(100vh-102px)] font-poppins max-lg:min-h-[calc(100vh-61px)]">
      <div className="flex bg-cover bg-no-repeat bg-left-bottom justify-center  w-[46%] max-lg:bg-sign max-lg:w-[100%] 
        py-[50px] px-[100px] max-sm:px-[16px] max-sm:py-[24px]">
          ...
          {step === 1 && (
            <form  onSubmit={onSubmit} className="self-center w-full max-w-[425px] max-lg:bg-white 
              ...
              <p className="text-[16px] leading-[26px] text-center text-simple-text mb-[32px] max-[690px]:mb-[10vh]">
                {t<string>("SIGN.RESET_PASSTEXT")}</p> 
              ...
              <div className="form-group mb-[24px]">
                ...
                />
                {/* <div className="error-input">This field is required</div> */}
              </div>  
              ...
              <p className="text-center flex items-center justify-center">
                <Link to="/sign-in" className="flex items-center text-[14px] leading-[18px] text-buttons-bg font-medium gap-[6px]">
                  <img src={back} alt="" />
                  {t<string>("SIGN.BACK")}
                </Link>
              </p>
          ...
          {step === 2 && (
            <div className="self-center w-full max-w-[425px] max-lg:bg-white 
              max-lg:px-[48px] max-lg:py-[60px] max-[690px]:px-[16px] max-[690px]:py-[32px] max-[690px]:rounded-[8px]
              max-[690px]:min-h-[calc(100vh-140px)]">
              <div className="table relative mx-[auto] mb-[45px]">
                <img src={arrow} className="w-[116px] absolute top-[46px] right-[98%]" alt="" />
              ...
              <p className="mb-[16px]">
                <span className="text-[16px] leading-[26px] text-simple-text tracking-[-0.1px] mr-[12px]">{t<string>("SIGN.DIDNT_RECEIVE")}</span>
                <Link  to="/sign-up" className="text-[14px] leading-[18px] text-buttons-bg font-medium inline-block"> 
                  {t<string>("SIGN.SUPPORT")}
                </Link> 
              </p>
              <p>
                <span className="text-[16px] leading-[26px] text-simple-text tracking-[-0.1px] mr-[12px]">
                  {t<string>("SIGN.TAKE_BACK")}</span>
                <Link  to="/sign-in" className="text-[14px] leading-[18px] text-buttons-bg font-medium inline-block"> 
                  {t<string>("SIGN.LOGIN")}
                </Link> 
              </p>              
            </div>
