    ...
    <div
      className={classNames({
        "bg-list-title p-[24px] rounded-[8px] border-[1px] border-solid border-card-border flex flex-col  gap-[16px] justify-between hover:shadow-card":
          true,
        "max-2xl:max-w-[357px] max-xl:max-w-[340px] max-sm:max-w-[343px] max-[2056px]:max-w-[calc(25%-16px)] h-[343px]":
          listType,
        "max-w-full": !listType,
      ...
      <div className="flex flex-row justify-between">
        <div
          className={classNames({
            ...
            "bg-card-border": task.status === "Not started",
        ...
        >
          <span
            className={classNames({
              ...
              "text-footer-main": task.status === "Not Started",
