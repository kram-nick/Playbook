...
const CookiesPopup = () => {
  const [cookies, setsetCookies] = useState<any>({
    show: false,
    cookie: "",
  });
    ...
    return (
      <div
        className={classNames({
          "w-full fixed bottom-[20px] right-[36px] z-10  flex justify-end":
            true,
          "translate-y-[300px] duration-400  transition-transform": !animate,
