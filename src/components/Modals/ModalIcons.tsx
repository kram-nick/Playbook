            ...
            className="modal-box relative w-[100%] max-w-[480px] px-[24px] py-[24px] shadow-free-trial 
              border-[1px] border-solid border-border-btn bg-white font-poppins">
                    ...
                    {tabs.map((item: any, index: number) => (
                      <div key={index}  onClick={() => setActiveTab(item)}
                        ...
                        <div  className={classNames({
                            ...
                            "absolute bottom-[-15px] left-[-1px] h-[1px] transition duration-300 ease-in bg-buttons-bg" : true
                          })}>
                        </div>
                      </div>
                    ))}                    
                ...
                {activeTab && activeTab.id === 3 && (
                  <div className="mt-[24px] px-[24px] py-[24px] border-[1px] border-solid border-header-bottom bg-white 
                    ...
                    <p className="text-center text-[14px] tracking-[-0.1px] font-normal leading-[20px] text-simple-text">
                      <span className="mr-[5px] text-buttons-bg">{t<string>("FIELDS.B_FILES")}</span>
