          ...
          <div className="flex flex-col gap-[24px] justify-between min-w-[486px] w-full">
            ...
            <div className="flex flex-col gap-[12px]">
              ...
              <p className="text-[16px] normal font-poppins font-normal text-footer-main leading-[26px] tracking-[-0.1px]">
                This is a playbook that helps you build new products to launch
                to the Saas Market. Chris explains how you can build the best
                business you can imagine. This is a playbook that helps you
                build new products to launch to the Saas Market. Chris explains
                how you can build the best business you can imagine.
              </p>
            </div>
