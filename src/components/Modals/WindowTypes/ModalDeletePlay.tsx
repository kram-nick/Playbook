...
export default function ModalDeletePlay() {
  ...
  const deleteItem = async () => {
    try {
      await PlaybookService.DeletePlay(sharedId);
      closeModal();
      toast.success(t<string>("MAIN.DELETE_PLAY_SUCCESS"));
