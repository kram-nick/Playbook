...
const Testimonials = () => {
  ...
  return (
    <section
      className="bg-white min-[1024px]:pt-[80px] min-[1024px]:pb-[140px] max-[1024px]:pt-[110px] max-[1024px]:pb-[110px]
      ...
      <div className="w-[100%] max-w-[1264px] px-[32px] mx-[auto] font-poppins max-[650px]:px-[16px]">
        ...
        >
          {[1, 2, 3, 4].map((index: number) => (
            ...
            >
              <div
                className="bg-white p-[40px] rounded-[20px] shadow-review border-[1px] border-header-bottom rotate-[-3deg] 
            max-[1024px]:p-[30px] max-[650px]:rotate-[-1.5deg]"
              >
                <div
                  className="quote mb-[40px] rounded-[50%] w-[40px] h-[40px] bg-banner-bg flex p-[8px] items-center justify-center
                max-[1024px]:mb-[30px]"
                >
                  <img
                    src={quote}
                ...
                <h4 className="text-[20px] leading-[28px] text-home-title tracking-[-0.1px] mb-[2px]">
                  James Tribbitt
                </h4>
                <p className="text-[12px] leading-[16px] text-simple-text tracking-[-0.1px] mb-[16px]">
                  Financial Coach
                </p>

                <p className="text-[16px] leading-[26px] text-home-title tracking-[-0.1px]">
                  They helped me model my multi-phase retirement plan with
                  multiple sources of income. The level of detail possible with
                  ProjectionLab is unmatched by other tools. I'm more confident
                  in my plan because of Playbook!
                </p>
              </div>
            </SwiperSlide>
          ))}
